...
validStudies <- labkey.selectRows(baseUrl = labkey.url.base,
                           folderPath = "/home/",
                           schemaName = "study",
...
studyPersonnel <- labkey.selectRows(baseUrl = labkey.url.base,
                        folderPath = "/Studies/",
                        schemaName = "immport",
...
studyOverview <- labkey.selectRows(baseUrl = labkey.url.base,
                           folderPath = "/Studies/",
                           schemaName = "immport",
                           queryName = "study",
                           colNameOpt = "fieldname",
...
assayTimepoint <- labkey.selectRows(baseUrl = labkey.url.base,
                        folderPath = "/Studies/",
                        schemaName = "study",
